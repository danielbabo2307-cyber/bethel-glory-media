function Modele058({
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-8 top-24 h-20 w-20 rounded-full border-8 border-white/10" />
      <div className="absolute bottom-40 left-8 h-14 w-14 rounded-full bg-white/5" />
