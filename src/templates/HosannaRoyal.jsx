function Modele087({
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-0 top-0 h-48 w-20 -skew-x-12 bg-white/10" />
      <div className="absolute bottom-0 left-0 h-40 w-12 skew-x-12 bg-white/5" />
