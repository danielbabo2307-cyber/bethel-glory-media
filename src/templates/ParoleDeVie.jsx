function Modele054({
  ...
  return (
    ...
    >
      ...
      <div className="absolute right-[-20px] top-20 h-40 w-40 rounded-full border-[18px] border-white/5" />
      <div className="absolute bottom-48 left-[-30px] h-32 w-32 rounded-full border-[12px] border-white/10" />
  ...
  <div className="flex items-center justify-between border-b border-white/20 pb-3">
    <div>
      <span className="text-[8px] font-bold uppercase tracking-[0.4em]" style={{color: palette.accent}}>
        EPICI
      </span>
